...
public class Sender {
  ...
  public static void main(String[] args) throws Exception {
    ...
    out.println("엄진영입니다. 안녕하세요!"); // 서버로 보낸 데이터
    System.out.println("서버에 데이터 보냈음!"); // 아래의 keyscan.nextLine() 때문에 엔터를 눌러야 서버가 보낸 데이터를 읽는 것인데도
                                        // 출력된것을
                                        // 보아 서버가 읽지 않아도 리턴됨을 증명

    keyscan.nextLine(); // 서버가 보낸 문자열을 읽지 않고 대기함!(엔터를 입력해야 읽음)
